...
if (isset($_POST['signup'])) {
    ...
    $name = trim($_POST['fullname']); // get posted data and remove whitespace
    $email = trim($_POST['email']);
    $upass = trim($_POST['pass']);
	$mobile= trim($_POST['num']);
	$dob=    trim($_POST['dob']);
    ...
    if ($count == 0) { // if email is not found add user
        ...
        $stmts = $conn->prepare("INSERT INTO users(name,email,password,mobile,dob,gender,address,country,state) VALUES('$name','$email','$password','$mobile','$dob','$gender','$address','$country','$state')");
        ...
        <form method="post" autocomplete="off">
            ...
            <div class="col-md-12">
				...
				<div class="form-group">
                    <div class="input-group">
                        <span class="input-group-addon"><span class="glyphicon glyphicon-lock"></span></span>
                        <input type="number" name="num" class="form-control" placeholder="Enter Mobile Number"
                               required/>
                    </div>
                </div>
				<div class="form-group">
                    <div class="input-group">
                        <span class="input-group-addon"><span class="glyphicon glyphicon-lock"></span></span>
                        <input type="date" name="dob" class="form-control" placeholder="Enter Your Age"
                               required/>
                    </div>
                </div>
				<div class="form-group">
